...
export default function ContactContent() {
    ...
    async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            const response = await fetch("https://formspree.io/f/mojdbevr", {
                method: "POST",
                body: formData,
                headers: {
            ...
            if (error instanceof TypeError && error.message === 'Failed to fetch') {
                alert('Message could not be sent. Please disable any ad-blockers (like uBlock Origin) or check your internet connection and try again.');
            } else {
                alert(t('form.error'));
            }
        } finally {
