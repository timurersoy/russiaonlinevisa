...
export default function TrackPage() {
    const t = useTranslations('Common'); // Fallback or new namespace? Let's use hardcoded for now or generic
    // Actually, I should check if I have message keys. 
    // For speed and robustness in this "simple tool" request, I'll hardcode visible text or use generic keys if available.
    // The user request is specific about the text.
